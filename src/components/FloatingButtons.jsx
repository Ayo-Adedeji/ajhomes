...
const FloatingButtons = () => {
  ...
  const openWhatsApp = () => {
    ...
    const phoneNumber = "447308181461" // UK number format without +
    const message = "Hello! I'm interested in your rental properties. Can you help me?"
      ...
      <AnimatePresence>
        {showButtons && (
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="group relative w-14 h-14 bg-brand-green hover:bg-brand-green-dark rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
          >
